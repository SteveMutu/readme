...
export class GoalComponent implements OnInit {
  goals: Goals[] = [
    ...
    new Goals(3,'Get new Phone Case','Diana has her birthday coming up soon',new Date(2022,1,12)),
    ...
    new Goals(6,'Plot my world domination plan','Cause I am an evil overlord',new Date(2030,3,14)),
  ];
  toggleDetails(index){
